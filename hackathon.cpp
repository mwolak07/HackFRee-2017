...
string output1(void)
{
	string output1="Your eyes open slowly. You find yourself in a dark and featureless room. You are nearly conscious now, and start to observe your surroundings. To you left, right, and directly behind you are solid concrete walls. Just five feet from your face is an array of sturdy and seemingly indestructible metal bars. As you begin to regain your memory, recollections of being caught (but completely uninvolved) in a major bank heist begin to appear. You realize that the room you are stranded in is one of the several cells in a high security prison.(Type all answers in camelcase)";
	return output1;
}

string output2(void)
{
	string output2="You suddenly start to feel the numbness from your legs dissipate. You decide to... Call out to a cellmate(CallOut); Stand up and walk towards the metal bars(MetalBars); Explore your surroundings further(Explore);";
	return output2;
}

string output3(void)
{
	string output3="You call out to the cellmate across the hallway that separates the two cells. 'Hey!', you scream. The cellmate turn their head and shakes it slowly at you, returning back to staring at the ground in silence. You hear footsteps approaching your cell and turn to see a security officer heading towards you. He looks you in the eyes and says, 'You're new here, so I'll just give you a warning. There is absolutely no verbal contact between prisoners. Next time, I won't be this kind.' He walks away. You go back to the bed in the center of your cell and sit down. (Go back to the other two choices). You now decide to... Stand up and walk towards the metal bars (MetalBars); Explore your surroundings further(Explore)";
	return output3;
}

string output4(void)
{
	string output4="Hmm, nothing to see here... (Go back to the other two choices) You now decide to... Explore your surroundings further.(Explore)";
	return output4;
}

string output5(void)
{
	string output5="You stand up and walk around the cell, darting your eyes across the floor and walls that surround you. You notice there's a pillow with a small tear in it, a few pieces of metal and shavings from the bars. You decide to pick up and investigate... The metal shavings(MetalShavings); The pillow(Pillow)";
	return output5;
}
...
int main(void)
{
	...
	string choice;
		...
		if(choice=="SmashAgainstBars")
		{
			cout<<output9()<<"\n";
			cout<<"choice: ";
			cin>>choice;
		}
		if(choice=="SmashAgainstLock")
		{
			cout<<output9()<<"\n";
			cout<<"choice: ";
			cin>>choice;
		}
		if(choice=="PickAtLock")
		{
			cout<<output10()<<"\n";
			cout<<"choice: ";
			cin>>choice;
		}
		if(choice=="BoltToExit")
		{
			cout<<output11()<<"\n";
			cout<<"choice: ";
			cin>>choice;
		}
		if(choice=="AssessWaysToExit")
		{
			cout<<output12()<<"\n";
			cout<<"choice: ";
			cin>>choice;
		}
		if(choice=="DistractHim")
		{
			cout<<output13()<<"\n";
			cout<<output15()<<"\n";
			health=0;
